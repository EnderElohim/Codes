...
namespace UnityEngine.UI
{
    ...
    public class scrCustomScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
                ...
                for (int axis = 0; axis < 2; axis++)
                {
                    ...
                    else if (m_Inertia)
                    {
                        ...
                        if (Mathf.Abs(m_Velocity[axis]) < 1)
                            m_Velocity[axis] = 0;
                        position[axis] += m_Velocity[axis] * deltaTime * currentSpeed;
                    }
